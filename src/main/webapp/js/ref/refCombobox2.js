...
(function($) {
	//保存源方法
	$.fn.combobox.methods_old = new Object();
	$.fn.combobox.methods_old = $.fn.extend(true,{},$.fn.combobox.methods);
	//改写方法
	/*
	...
	*/
		...
		loadRefDataAfterProc:function(op,data){
			...
			if (op.childOption.refId){
				...
				if (op.isSetdefaultValue){
					var rec = $(p_id).combobox('valueObj');
	...
	$.extend($.fn.combobox.methods,{
		...
		callOldMethod:function(jq,key,a,b,c,d){
			var oldLoadDataMethod = $.fn.combobox.methods_old[key]
			return oldLoadDataMethod.call($.fn.combobox.methods,jq,a,b,c,d);
		},
		/**
		 * 添加查询参数
		 * @param params 参数
