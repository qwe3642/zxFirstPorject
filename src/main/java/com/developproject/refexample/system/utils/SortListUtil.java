/**   
 * @Title: SortListUtil.java 
 * @Package com.timesoft.util 
 * @Description: TODO(用一句话描述该文件做什么) 
 * @author zhangzhw   
 * @date 2015-7-14 下午3:51:01 
 * @version V1.0   
 */
...
/**
 * 通用工具类之按对象中某属性排序 1.按对象的一个属性和多个属性进行排序. 2.按对象属性正序和倒序排列.
 * 3.完美支持int等基础类和Integer等包装类. 4.完美支持属性为实现了Comparable接口的类.
