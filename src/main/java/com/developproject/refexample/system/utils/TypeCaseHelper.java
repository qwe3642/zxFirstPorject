...
public class TypeCaseHelper {
	...
	public static <T> T convertGenerics(Object obj, Class<?> type, String format) throws TypeCastException {
		return (T)convertGenerics(obj, type.getName(), format);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> T convertGenerics(Object obj, String type, String format) throws TypeCastException {
		return (T)convert(obj, type, format);
	}
	 ...
	 * @see [类、类#方法、类#成员]
	 */
	public static Object convert(Object obj, Class<?> type, String format) throws TypeCastException {
	...
	public static Object convert(Object obj, String type, String format) throws TypeCastException {
		...
		if ("Object".equals(type) || "java.lang.Object".equals(type))
			return obj;
		String fromType = SystemCommonF.setNullObj();
		if (obj instanceof String) {
			...
			if (str.length() == 0)
				return null;
			if ("Boolean".equals(type) || "java.lang.Boolean".equals(type) || "boolean".equals(type) || "java.lang.boolean".equals(type)) {
				Boolean value = SystemCommonF.setNullObj();
			...
			if ("Double".equals(type) || "java.lang.Double".equals(type) || "double".equals(type) || "java.lang.double".equals(type))
				try {
			...
			if ("Float".equals(type) || "java.lang.Float".equals(type) || "float".equals(type) || "java.lang.float".equals(type))
				try {
					Number tempNum = getNf(locale).parse(str);
			...
			if ("Long".equals(type) || "java.lang.Long".equals(type) || "long".equals(type) || "java.lang.long".equals(type))
				try {
			...
			if ("Integer".equals(type) || "java.lang.Integer".equals(type) || "int".equals(type) || "java.lang.int".equals(type))
				try {
					NumberFormat nf = getNf(locale);
					nf.setMaximumFractionDigits(0);
					Number tempNum = nf.parse(str);
			...
			if ("Date".equals(type) || "java.sql.Date".equals(type) || "java.util.Date".equals(type)) {
				if (format == null || format.length() == 0)
					try {
						return Date.valueOf(str);
					} catch (Exception e) {
						try {
							DateFormat df = SystemCommonF.setNullObj();
							//if (locale != null)
		...
		if (obj instanceof BigDecimal) {
			...
			if ("String".equals(type) || "java.lang.String".equals(type))
				return String.valueOf(bigD);//getNf(locale).format(bigD.doubleValue());
			if ("BigDecimal".equals(type) || "java.math.BigDecimal".equals(type))
				return obj;
			if ("Double".equals(type) || "java.lang.Double".equals(type) || "double".equals(type) || "java.lang.double".equals(type))
		...
		if (obj instanceof Double) {
			...
			if ("String".equals(type) || "java.lang.String".equals(type))
				return DoubleUtil.DoubleToString(((Double) obj).doubleValue());
			if ("Double".equals(type) || "java.lang.Double".equals(type) || "double".equals(type) || "java.lang.double".equals(type))
				return obj;
			if ("Float".equals(type) || "java.lang.Float".equals(type) || "float".equals(type) || "java.lang.float".equals(type))
		...
		if (obj instanceof Float) {
			...
			Float flt = (Float) obj;
			if ("String".equals(type) || "java.lang.String".equals(type))
				return String.valueOf(flt);//getNf(locale).format(flt.doubleValue());
			if ("BigDecimal".equals(type) || "java.math.BigDecimal".equals(type))
		...
		if (obj instanceof Long) {
			...
			Long lng = (Long) obj;
			if ("String".equals(type) || "java.lang.String".equals(type))
				return String.valueOf(lng);//getNf(locale).format(lng.longValue());
			if ("Double".equals(type) || "java.lang.Double".equals(type) || "double".equals(type) || "java.lang.double".equals(type))
		...
		if (obj instanceof Integer) {
			...
			if ("String".equals(type) || "java.lang.String".equals(type))
				return String.valueOf(intgr);//getNf(locale).format(intgr.longValue());
			if ("Double".equals(type) || "java.lang.Double".equals(type) || "double".equals(type) || "java.lang.double".equals(type))
	...
	private static NumberFormat getNf(Locale locale) {
		NumberFormat nf = SystemCommonF.setNullObj();
		if (locale == null)
