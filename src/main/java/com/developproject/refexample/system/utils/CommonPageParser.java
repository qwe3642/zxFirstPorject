...
public class CommonPageParser {
	...
	static{
		try{
			//获取文件模板根路径
			//String  templateBasePath = Constants.WORK_TEMPLATE_PATH;  getRootPath
			String  templateBasePath =getRootPath();
			templateBasePath = templateBasePath + "template\\";
...
//	    	System.out.println("页面生成成功"+file.getAbsolutePath());
	...
	public static String getRootPath(){
		...
		try{
			 ...
			 rootPath = file.getParentFile().getParentFile().getParentFile()+"\\developproject\\";
