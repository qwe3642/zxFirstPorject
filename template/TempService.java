 ...
 * 修改内容:  <修改内容>
 */
package com.timesoft.${module}.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import com.timesoft.${module}.mapper.${className}Mapper;
import com.timesoft.${module}.dto.${className}Dto;
import com.timesoft.common.service.BaseService;
/**
 ...
 * 
 */
@Service("com.timesoft.${module}.service.${className}Service")
